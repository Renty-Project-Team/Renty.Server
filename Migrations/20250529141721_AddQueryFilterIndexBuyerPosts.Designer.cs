...
namespace Renty.Server.Migrations
{
    ...
    [Migration("20250529141721_AddQueryFilterIndexBuyerPosts")]
    partial class AddQueryFilterIndexBuyerPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Renty.Server.Post.Domain.BuyerPostImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Renty.Server.Post.Domain.BuyerPosts", b =>
                {
                    ...
                    b.HasIndex("DeletedAt", "BuyerUserId");

                    b.HasIndex("DeletedAt", "CreatedAt", "CategoryId");
            ...
            modelBuilder.Entity("Renty.Server.Post.Domain.BuyerPosts", b =>
                {
                    ...
                    b.HasOne("Renty.Server.Product.Domain.Categorys", "Category")
                        .WithMany("BuyerPosts")
